...
class ChatifyServiceProvider extends ServiceProvider
{
    ...
    protected function setPublishes()
    {
        ...
        $this->publishes([
            ...
            __DIR__ . '/database/migrations/2022_01_10_99999_add_channel_id_to_users.php' => database_path('migrations/' . date('Y_m_d') . '_999999_add_channel_id_to_users.php'),
            ...
            __DIR__ . '/database/migrations/2022_01_10_99999_create_chatify_channels_table.php' => database_path('migrations/' . date('Y_m_d') . '_999999_create_chatify_channels_table.php'),
            ...
            __DIR__ . '/database/migrations/2022_01_10_100000_create_chatify_channel_user_table.php' => database_path('migrations/' . date('Y_m_d') . '_1000000_create_chatify_channel_user_table.php'),
        ], 'chatify-migrations');
